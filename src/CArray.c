...
void T##_array_free_data(Array_Name *array) {                                                                              \
    if (array->data) {                                                                                                     \
        free(array->data);                                                                                                 \
        array->data = NULL;                                                                                                \
    } else {                                                                                                               \
    ...
    array->count = 0;                                                                                                      \
                                                                                                                           ...
                                                                                                                           \
void T##_array_clear(Array_Name *array) {                                                                                  \
    array->count = 0;                                                                                                      \
}                                                                                                                          \
                                                                                                                           \
inline T *T##_array_last(Array_Name *array) {                                                                              \
    return &array->data[array->count - 1];                                                                                 \
}                                                                                                                          \
inline T T##_array_last_value(Array_Name *array) {                                                                         \
    return array->data[array->count - 1];                                                                                  \
}                                                                                                                          \
inline T *T##_array_get(Array_Name *array, i32 index) {                                                                    \
    assert((index >= 0 && index < array->count) && "Index out of bounds!");                                                \
                                                                                                                           \
    return &array->data[index];                                                                                            \
}                                                                                                                          \
                                                                                                                           \
inline T T##_array_get_value(Array_Name *array, i32 index) {                                                               \
    assert((index >= 0 && index < array->count) && "Index out of bounds!");                                                \
                                                                                                                           \
    return array->data[index];                                                                                             \
}                                                                                                                          \
                                                                                                                           \
T *T##_array_append(Array_Name *array, T value) {                                                                          \
    grow_if_need((void **)(&array->data), sizeof(T), &array->capacity, array->count, 1);                                   \
                                                                                                                           \
    array->data[array->count] = value;                                                                                     \
    array->count += 1;                                                                                                     \
                                                                                                                           \
    return T##_array_last(array);                                                                                          \
}                                                                                                                          \
                                                                                                                           \
void T##_array_append_another_array(Array_Name *array, Array_Name *another_array) {                                        \
    for_array(i, another_array) {                                                                                          \
        T##_array_get_value(another_array, i);                                                                             \
    }                                                                                                                      \
}                                                                                                                          \
                                                                                                                           \
void T##_array_just_decrease_count(Array_Name *array) {                                                                    \
    array->count -= 1;                                                                                                     \
...
b32 T##_array_values_equal(Array_Name *array, Array_Name *another_array) {                                                 \
    if (array->count != another_array->count) return false;                                                                \
                                                                                                                           \
    for_array(i, array) {                                                                                                  \
        if (compare_function(*T##_array_get(array, i), *T##_array_get(another_array, i))) {                                \
            return false;                                                                                                  \
        }                                                                                                                  \
    }                                                                                                                      \
                                                                                                                           \
...
T *T##_array_increase_count_and_get_last(Array_Name *array) {                                                              \
    array->count += 1;                                                                                                     \
    assert(array->count <= array->capacity);                                                                               \
    return T##_array_last(array);                                                                                          \
}                                                                                                                          \
                                                                                                                           \
void T##copy_values(Array_Name *array, Array_Name *another_array) {                                                        \
    T##_array_clear(array);                                                                                                \
    T##_array_append_another_array(array, another_array);                                                                  \
}                                                                                                                          \
                                                                                                                           \
T *T##_array_insert(Array_Name *array, T value, i32 index) {                                                               \
    ...
    return &array->data[index];                                                                                            \
                                                                                                                           ...
                                                                                                                           \
void T##_array_remove(Array_Name *array, i32 index) {                                                                      \
    assert((index >= 0 && index < array->count) && "Index out of bounds!");                                                \
                                                                                                                           \
    if (index == array->count - 1) {                                                                                       \
        ...
        return;                                                                                                            \
                                                                                                                           ...
                                                                                                                           \
    memmove(T##_array_get(array, index), T##_array_get(array, index+1), sizeof(T) * (array->count - index - 1));           \
    array->count--;                                                                                                        \
}                                                                                                                          \
                                                                                                                           \
inline void T##_array_remove_first_encountered(Array_Name *array, T *value) {                                              \
    i32 index = T##_array_find(array, value);                                                                              \
    if (index >= 0) T##_array_remove(array, index);                                                                        \
}                                                                                                                          \
inline void T##_array_remove_first_encountered_value(Array_Name *array, T value) {                                         \
    T##_array_remove_first_encountered(array, &value);                                                                     \
}                                                                                                                          \
                                                                                                                           \
inline void T##_array_remove_all_encountered(Array_Name *array,T *value) {                                                 \
    for_array(i, array) {                                                                                                  \
        if (compare_function(*T##_array_get(array, i), *value)) {                                                          \
            T##_array_remove(array, i);                                                                                    \
            i--;                                                                                                           \
        }                                                                                                                  \
    }                                                                                                                      \
}                                                                                                                          \
inline void T##_array_remove_all_encountered_value(Array_Name *array, T value) {                                           \
    remove_all_encountered(&value);                                                                                        \
}                                                                                                                          \
                                                                                                                           \
void T##_array_remove_first_half(Array_Name *array){                                                                       \
    i32 half_count = (i32)((f32)array->count * 0.5f);                                                                      \
    i32 even_correction = array->count % 2 == 0 ? -1 : 0;                                                                  \
    memcpy(T##_array_get(array, 0), T##_array_get(array, half_count + even_correction), half_count * sizeof(T));           \
                                                                                                                           \
...
inline Array_Name T##_array_get_unique_elements_differences(Array_Name *array, Array_Name *another_array) {                \
    ...
    for_array(i, biggest) {                                                                                                \
        if (!T##_array_contains(smallest, T##_array_get(biggest, i))) {                                                    \
            T##_array_append(&result, T##_array_get_value(biggest, i));                                                    \
        }                                                                                                                  \
    }                                                                                                                      \
                                                                                                                           \
    return result;                                                                                                         \
                                                                                                                           ...
                                                                                                                           \
inline i32 T##_array_find(Array_Name *array, T *to_find) {                                                                 \
    for_array(i, array) {                                                                                                  \
        if (compare_function(*T##_array_get(array, i), *to_find)) {                                                        \
            return i;                                                                                                      \
        }                                                                                                                  \
...
inline i32 T##_array_find_value(Array_Name *array, T to_find) {                                                            \
    return T##_array_find(array, &to_find);                                                                                \
}                                                                                                                          \
                                                                                                                           \
inline i32 T##_array_find_from(Array_Name *array, T *to_find, i32 from) {                                                  \
...
inline i32 T##_array_find_from_value(Array_Name *array, T to_find, i32 from) {                                             \
    return T##_array_find_from(array, &to_find, from);                                                                     \
}                                                                                                                          \
